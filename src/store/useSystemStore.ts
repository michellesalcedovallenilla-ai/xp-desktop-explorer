...
const defaultDesktopIcons: DesktopIconData[] = [
  { id: 'ie', label: 'Internet Explorer', icon: 'ie', type: 'app', action: 'ie', x: 100, y: 140, iconWidth: 120, locked: true },
  { id: 'music', label: 'Music', icon: 'music', type: 'app', action: 'music', x: 350, y: 250, iconWidth: 100, locked: true },
  { id: 'camera', label: 'Camera', icon: 'camera', type: 'app', action: 'camera', x: 600, y: 130, iconWidth: 120, locked: true },
  { id: 'about', label: 'About Me', icon: 'about', type: 'app', action: 'about', x: 230, y: 350, iconWidth: 150, locked: true },
  { id: 'hd', label: 'My Computer', icon: 'hd', type: 'app', action: 'finder', x: 440, y: 320, iconWidth: 180, locked: true },
  { id: 'resume', label: 'Resume.pdf', icon: 'resume', type: 'file', action: 'resume', x: 670, y: 370, iconWidth: 120, locked: true },
  { id: 'contact', label: 'Contact', icon: 'contact', type: 'app', action: 'contact', x: 80, y: 500, iconWidth: 110, locked: true },
  { id: 'minesweeper', label: 'Games', icon: 'minesweeper', type: 'app', action: 'minesweeper', x: 880, y: 250, iconWidth: 350, locked: true },
  { id: 'projects', label: 'Projects', icon: 'projects', type: 'folder', action: 'finder', x: 1150, y: 480, iconWidth: 250, locked: true }
]
...
const defaultWidgets: WidgetState[] = [
  { id: 'calculator', type: 'calculator', x: 900, y: 60, isVisible: false, zIndex: 1 },
  { id: 'weather', type: 'weather', x: 580, y: 60, isVisible: false, zIndex: 2 },
  { id: 'clock', type: 'clock', x: 370, y: 60, isVisible: false, zIndex: 3 },
  { id: 'calendar', type: 'calendar', x: 580, y: 370, isVisible: false, zIndex: 4 },
  { id: 'music', type: 'music', x: 900, y: 310, isVisible: false, zIndex: 5 },
  { id: 'notes', type: 'notes', x: 370, y: 370, isVisible: false, zIndex: 6 }
]
