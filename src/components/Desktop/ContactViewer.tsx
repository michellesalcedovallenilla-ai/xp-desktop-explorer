      ...
      <div className="xp-contact-left">
        ...
        <div className="xp-contact-socials">
          ...
          <a href="https://www.fiverr.com/chellesalcedo" target="_blank" rel="noopener noreferrer" className="xp-social-link" title="Fiverr">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M16.25 16.25v-10h-2v10h2zm-6-4v4h2v-4c0-1.1.9-2 2-2h1v-2h-1c-2.21 0-4 1.79-4 4zm11.75-7.25h-20v18h20v-18zm-2 16h-16v-14h16v14zM7.5 16.25H6v-4.5c0-.41.34-.75.75-.75s.75.34.75.75v4.5zM6.75 9.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/></svg>
          </a>
        </div>
      </div>
