      ...
      <div className="xp-contact-left">
        ...
        <div className="xp-contact-socials">
          ...
          <a href="https://www.fiverr.com/chellesalcedo" target="_blank" rel="noopener noreferrer" className="xp-social-link" title="Fiverr">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="#1dbf73"><path d="M18.72 10.2h-1.52v4.87h-2.24V10.2h-1.13V8.37h1.13V7.45c0-1.87 1.09-2.88 2.75-2.88.75 0 1.4.11 1.4.11v1.83h-.79c-.78 0-1.02.48-1.02 1.02v.84h1.75l-.28 1.83h-1.47v4.87h-2.24V10.2zM6.91 15.07H4.67V8.37h2.24v6.7zM5.79 7.27a1.3 1.3 0 1 1 0-2.6 1.3 1.3 0 0 1 0 2.6z"/></svg>
          </a>
        </div>
      </div>
